...
public class FollowerConstants {
    ...
    private static double xMovement = 66.4892;
    private static double yMovement = 48.5835;
    ...
    public static double mass = 8.71;
    ...
    public static double forwardZeroPowerAcceleration = -64.5029;
